...
const GITHUB_REPO = String(process.env.CAJAL_GITHUB_REPO || '').trim();
const UPDATE_IMAGE = String(process.env.CAJAL_UPDATE_IMAGE || '').trim();
const WATCHTOWER_URL = String(process.env.CAJAL_WATCHTOWER_URL || '').trim().replace(/\/$/, '');
