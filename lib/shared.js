...
let ldapRuntimeConfig = { serverUrl: '', port: 389, baseDn: '', adminGroup: '', monitorGroup: '', bindDn: '', bindPassword: '' };
...
module.exports = {
  ...
  get ldapRuntimeConfig() { return ldapRuntimeConfig; },
  set ldapRuntimeConfig(v) { ldapRuntimeConfig = v; },
