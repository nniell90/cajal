...
function createSiteTemplate(name, category) {
  ...
  return {
    ...
    metrics: {
      ...
      snmp: { uptime: 'Unknown', lastPoll: 'Never', successCount: 0, failureCount: 0, lastSuccessAt: '', lastErrorAt: '', lastError: '', responseMs: 0, interfaces: [], interfaceCount: 0, interfacePollMs: 0, lastInterfacePoll: '' },
